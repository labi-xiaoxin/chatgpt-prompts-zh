...
![浏览量](https://visitor-badge.deta.dev/badge?page_id=labi_xiaoxin.chatgpt-prompts-zh&left_color=blue&right_color=green)

> 本项目源于https://github.com/PlexPt/awesome-chatgpt-prompts-zh

很多朋友们都用上了ChatGPT，不管是官网或是自建，都能够根据提示，生成相应的结果。

但是由于某些结果需要特定~~姿势~~对话才能正确解锁，本指北通过收集不同的对话数据，满足不同需求。
